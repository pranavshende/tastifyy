...
router.put('/', async (req, res) => {
    const restaurant_id = req.restaurant_id;
    const { name, description, phone, email, address_line, city, state, pincode, cuisine_tags, type, is_pure_veg, avg_preparation_time_mins, service_radius_km, is_open, pan_number, bank_account_number, ifsc_code, bank_beneficiary_name, } = req.body;
    try {
