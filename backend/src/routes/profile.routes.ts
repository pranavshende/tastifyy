...
const attachRestaurant = async (req: Request, res: Response, next: NextFunction) => {
...
router.post('/location', async (req: Request, res: Response) => {
  const restaurant_id = (req as any).restaurant_id as string;
...
router.post('/location/change-request', async (req: Request, res: Response) => {
  const restaurant_id = (req as any).restaurant_id as string;
  const partner = (req as any).partner;
...
router.patch('/accepting-orders', async (req: Request, res: Response) => {
  const restaurant_id = (req as any).restaurant_id;
...
router.post('/cover', upload.single('image'), async (req: Request, res: Response) => {
  const restaurant_id = (req as any).restaurant_id;
  const file = req.file;
